namespace RecipesPlus.Web.Areas.Administration.Controllers
{
    ...
    public class CategoriesController : AdministrationController
    {
        ...
        {
            return this.View(await this.categoriesRepository.AllAsNoTracking().ToListAsync());
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var category = await this.categoriesRepository.AllAsNoTracking().FirstOrDefaultAsync(x => x.Id == id);
            if (category == null)
            {
                return this.NotFound();
            }
        ...
        {
            return this.categoriesRepository.AllAsNoTracking().Any(e => e.Id == id);
        }
    }
}
